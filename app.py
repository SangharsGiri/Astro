...
st.set_page_config(page_title="Astro Gaming", page_icon=":video_game:", layout="wide")
...
with st.container():
	...
	with colu2:
		...
		st.link_button("Mafia", "https://mafia77777.com/")
		st.link_button("Mega Spin", "https://www.megaspinsweeps.com/")
		st.link_button("Ultra Panda", "https://www.ultrapanda.mobi/")
		st.link_button("Vegas Sweeps", "https://m.lasvegassweeps.com/")
		st.link_button("River Sweeps", "https://river777.com/")
		st.link_button("Cash Machine", "https://www.cashmachine777.com/")
...
with st.container():
	...
	with colum2:
		st.write("---")
		st.link_button("Follow our Facebook page ASTRO GAMING", "https://www.facebook.com/godfathergamingg/")
		st.write("---")
	with colum3:
		st.write("")	
...
[data-testid="stAppViewContainer"] {
    background-image: url("https://www.istockphoto.com/vector/poker-table-background-in-green-color-gm1206505233-347995491");
